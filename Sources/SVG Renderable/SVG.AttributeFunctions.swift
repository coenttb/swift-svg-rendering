...
public func stroke(_ color: String, width: Double) -> SVG._Attributes<SVG.Empty> {
    SVG._Attributes(content: SVG.Empty(), attributes: ["stroke": color, "stroke-width": width.formatted(.number)])
}
...
public func strokeDashoffset(_ value: Double) -> SVG._Attributes<SVG.Empty> {
    SVG._Attributes(content: SVG.Empty(), attributes: ["stroke-dashoffset": value.formatted(.number)])
}
...
public func translate(x: Double = 0, y: Double = 0) -> SVG._Attributes<SVG.Empty> {
    SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "translate(\(x.formatted(.number)), \(y.formatted(.number)))"])
}

/// Creates an SVG rotate transform attribute.
public func rotate(_ angle: Double, cx: Double? = nil, cy: Double? = nil) -> SVG._Attributes<SVG.Empty> {
    if let cx = cx, let cy = cy {
        return SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "rotate(\(angle.formatted(.number)), \(cx.formatted(.number)), \(cy.formatted(.number)))"])
    }
    return SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "rotate(\(angle.formatted(.number)))"])
}

/// Creates an SVG scale transform attribute.
public func scale(x: Double, y: Double? = nil) -> SVG._Attributes<SVG.Empty> {
    if let y = y {
        return SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "scale(\(x.formatted(.number)), \(y.formatted(.number)))"])
    }
    return SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "scale(\(x.formatted(.number)))"])
}

/// Creates an SVG skewX transform attribute.
public func skewX(_ angle: Double) -> SVG._Attributes<SVG.Empty> {
    SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "skewX(\(angle.formatted(.number)))"])
}

/// Creates an SVG skewY transform attribute.
public func skewY(_ angle: Double) -> SVG._Attributes<SVG.Empty> {
    SVG._Attributes(content: SVG.Empty(), attributes: ["transform": "skewY(\(angle.formatted(.number)))"])
}
